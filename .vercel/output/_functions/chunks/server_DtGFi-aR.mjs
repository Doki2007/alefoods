import { c as createInvalidVariablesError, g as getEnv$1, s as setOnSetGetEnv } from './runtime_CB1AVKqV.mjs';

const schema = {"CONTENT_ISLAND_SECRET_TOKEN":{"context":"server","access":"secret","optional":false,"default":"INFORM_VALID_TOKEN","type":"string"},"RESEND_API_KEY":{"context":"server","access":"secret","optional":false,"default":"INFORM_VALID_TOKEN","type":"string"},"FROM_EMAIL":{"context":"server","access":"secret","optional":false,"default":"INFORM_VALID_EMAIL","type":"string"},"TO_EMAIL":{"context":"server","access":"secret","optional":false,"default":"INFORM_VALID_EMAIL","type":"string"}};
...
setOnSetGetEnv(() => {
	CONTENT_ISLAND_SECRET_TOKEN = _internalGetSecret("CONTENT_ISLAND_SECRET_TOKEN");
...
let CONTENT_ISLAND_SECRET_TOKEN = _internalGetSecret("CONTENT_ISLAND_SECRET_TOKEN");
...
export { CONTENT_ISLAND_SECRET_TOKEN as C, FROM_EMAIL as F, RESEND_API_KEY as R, TO_EMAIL as T };
