import { g as getActionQueryString, a as astroCalledServerError, A as ActionError, d as deserializeActionResult, b as ACTION_QUERY_PARAMS, c as appendForwardSlash } from './chunks/index_CkUZD4hx.mjs';
import { o as objectType, s as stringType } from './chunks/astro/server_BW5CY_U4.mjs';
import { Resend } from 'resend';
import { R as RESEND_API_KEY, T as TO_EMAIL, F as FROM_EMAIL } from './chunks/server_DwVfhyjd.mjs';
import { d as defineAction } from './chunks/server_w9nabmH5.mjs';
...
const server = {
  send: defineAction({
    accept: "form",
    input: objectType({
      name: stringType().min(2, "Nombre demasiado corto.").max(50, "Nombre demasiado largo."),
      mail: stringType().email("Email inválido").max(75),
      message: stringType().min(10, "Mensaje demasiado corto.").max(200, "Mensaje demasiado largo."),
